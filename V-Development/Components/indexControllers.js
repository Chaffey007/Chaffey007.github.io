...
(function () {
    ...
    myApp.config(['$routeProvider', '$locationProvider', function($routeProvider, $rootScope, $locationProvider){
        //... Check if Mobile ...
        /*var _tst = window.mobilecheck = function() {
            var check = false;
    ...
    /************************************************* Main Controller ************************************************************/
    /** ***********************************************************************************************************/
    myApp.controller('mainController', function($scope, $location, $rootScope, $timeout, $log, $http){
    ...
    myApp.controller('logisticsController',['$scope', '$rootScope', '$timeout', '$log', '$http', '$location', 'GlobeVars', 'scrollPageService', '$sce', 'currencyConvert', function($scope, $rootScope, $timeout, $log, $http, $location, GlobeVars, scrollPageService, $sce, currencyConvert){
        ...
        $scope.menuOptions = ['Home','About Us','Transport Services Overview','Technology Overview','Solutions Overview','Enquire','More'];
        ...
        $scope.enqDescSpec = 'query@intellicargogroup.co.za';
    ...
    /******************************** Login / Register *************************************/
    myApp.controller('loginCntrl', function ($scope, $rootScope, $timeout, $mdSidenav, $log, $http) {
            ...
            if(maile){
                ...
                $http({
                    ...
                    if(getResponse.data === 'DB Problem'){
                        ...
                        $scope.logError = true;
                        $scope.logErrorMsg = "Recovery mail sent to " + email;
                    }
